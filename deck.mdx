...
## Practice on Project
### How to construct?
1. For large (extended) project create *Interface* Project. And also the 'Implement Project'(eg. MongoDB, XiaoIce).
2. For 
...
- .Net Core also provide a new standard of project management(new csproj). And use PackageReference replace package.config. 
